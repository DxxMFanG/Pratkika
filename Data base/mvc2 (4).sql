...
INSERT INTO `academic_performances` (`id`, `discipline`, `student`, `rate`)
VALUES (1, 1, 3, 7),
       (2, 4, 3, 7),
       (3, 2, 3, 6),
       (5, 3, 3, 4),
...
INSERT INTO `disciplines` (`id`, `discipline_title`, `educational_plan`, `hours`, `type`, `title`)
VALUES (1, 2, 21, 44, '0', 'Пирвп (Группа 492, семестр 1, курс 1)'),
...
INSERT INTO `discipline_titles` (`id`, `title`)
VALUES (1, 'ГГ'),
       (2, 'Пирвп'),
       (3, 'Оаип'),
...
INSERT INTO `educational_plans` (`id`, `students_group`, `course`, `semester`, `title`)
VALUES (21, 6, 1, 1, 'Группа 492, семестр 1, курс 1'),
...
INSERT INTO `reports` (`id`, `educational_plan`, `image`)
VALUES (2, 22, 'C:\\xampp\\htdocs\\praktika\\app\\Model\\..\\..\\public\\upload\\'),
       (3, 21, 'public\\upload\\'),
...
INSERT INTO `roles` (`id`, `title`, `code`)
...
INSERT INTO `students` (`id`, `name`, `lastname`, `patronymic`, `sex`, `date_birth`, `address`, `students_group`)
VALUES (1, 'а', 'а', 'а', 1, '1111-01-01', '1', 6),
...
INSERT INTO `students_groups` (`id`, `title`, `course`, `semester`, `user`)
VALUES (6, 492, 3, 2, 14),
...
INSERT INTO `users` (`id`, `login`, `password`, `name`, `lastname`, `patronymic`, `date_birth`, `sex`, `address`,
                     `role`, `token`)
VALUES (1, '1', 'c4ca4238a0b923820dcc509a6f75849b', 'Иван', 'Иванов', 'Иванович', '1996-02-21', 1,
        'Ул.Пушкина, дом 12, кв 12', 1, NULL),
       (2, '2', 'c81e728d9d4c2f636f067f89cc14862c', 'Петр', 'Петров', 'Петрович', '1999-04-22', 1,
        'Ул. Герцена, дом 1, кв 1', 2, 'd0c3aff9d201c3037e0386866c98a79a'),
       (3, '3', 'eccbc87e4b5ce2fe28308fd9f2a7baf3', 'Василий', 'Васильев', 'Васильевич', '2015-02-19', 1,
        'вжыламщвмпощк оплкоылопрл', 3, 'c7403f0f64b6f629fd43661593d04316'),
       ...
       (14, '55', 'b53b3a3d6ab90ce0268229151c9bde11', 'КУРАТОР 14', '', NULL, NULL, NULL, NULL, 3,
        '3c2ab96fd335cf57dec76d32d4adb601'),
       (15, '11', '6512bd43d9caa6e02c990b0a82652dca', '&lt;script&gt;alert()&lt;/script&gt;', '11', '11', '1122-11-11',
        0, '11', 2, NULL),
       (16, 'gg', '73c18c59a39b18382081ec00bb456d43', 'гг', 'гг', 'гг', '0000-00-00', 0, 'гг', 2, NULL),
       (17, 'ist', 'e5a93371cfc7eab4a88221dd1f6c1a3c', 'Сергей', 'Истигечев', 'Сергеевич', '1999-12-12', 1,
        'г. Томск тыры пыры', 3, NULL),
       (18, 'you', '639bae9ac6b3e1a84cebb7b403297b79', 'Юрий', 'Грушевский', 'Викторович', '2000-05-03', 1,
        'Пушкина дом 10', 3, NULL),
       (20, 'c97ba3e8a04bff66acc0251586e25a3a', '21232f297a57a5a743894a0e4a801fc3', 'admin', '', NULL, NULL, NULL, NULL,
        0, NULL),
       (28, 'login is busy', '21232f297a57a5a743894a0e4a801fc3', 'admin', '', NULL, NULL, NULL, NULL, 0, NULL),
       (29, '7c7defeca8b2967cc67c56bb97995a83', '21232f297a57a5a743894a0e4a801fc3', 'admin', '', NULL, NULL, NULL, NULL,
        0, NULL);
...
ALTER TABLE `academic_performances`
  ...
  ADD CONSTRAINT `academic_performances_ibfk_2` FOREIGN KEY (`discipline`) REFERENCES `disciplines` (`id`) ON
DELETE
CASCADE ON
UPDATE CASCADE,
    ADD CONSTRAINT `academic_performances_ibfk_3` FOREIGN KEY (`rate`) REFERENCES `rates` (`id`)
ON
DELETE
CASCADE ON
UPDATE CASCADE;
...
ALTER TABLE `disciplines`
  ...
  ADD CONSTRAINT `disciplines_ibfk_2` FOREIGN KEY (`educational_plan`) REFERENCES `educational_plans` (`id`) ON
DELETE
CASCADE ON
UPDATE CASCADE;
